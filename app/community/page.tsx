...
export default function Community() {
  ...
  const RenderExdata = Array(ExdataLen).fill(null);
  const RenderAlldata = Array(AlldataLen).fill(null);
  ...
  return (
    <div className="bg-[#F1EAFF] w-full h-100vh flex flex-wrap lg:flex-nowrap gap-3" >
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row gap-4">
              <button onClick={handlePrev}><Image src="/lfarw.svg" alt="arr" width={7.89} height={13.99} /></button>
              <button onClick={handleNext}><Image src="/rfarw.svg" alt="arr" width={7.89} height={13.99} /></button>
