...
const RightSide: React.FC = () => {
  ...
  return (
    <div className=" w-[48%] h-screen bg-[#E8E2F4] border-[0.2px] border-l-[#828282] max-w-[380px] py-3 px-3 relative  ">
      <div className='w-full h-full   bg-white rounded-lg'>
        ...
        <div className="float text-[15px]  bg-white h-fit  w-full  rounded-md shadow-sm font-[200]  p-4 ">
          ...
          <div onClick={Answer} className="bg-[#E8E2F4] w-full cursor-pointer max-w-[330px] h-[39px] mt-3 flex items-center border-solid border-[1.49px] border-[#8C52FF] rounded-full ...">
            <p className='mx-4'>
