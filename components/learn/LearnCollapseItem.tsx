...
export default function LearnCollapseItem() {
    ...
    return (
        <>
            <div className="w-50 h-14 md:w-80 md:h-16 border-[0.5px] border-[rgb(130,130,130)] flex text-black hover:text-[#8C52FF] justify-between mb-7 rounded-md bg-[#E8E2F4] hover:bg-white ">
