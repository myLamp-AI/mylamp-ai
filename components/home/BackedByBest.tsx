        ...
        <>
            <div className="bg-white flex flex-col justify-center items-center my-4 pb-4 min-h-[600px]">
                ...
                <div className='flex flex-wrap w-full items-center justify-evenly'>
                    <div className='w-1/3 min-h-[300px] flex flex-col justify-between drop-shadow-md font-semibold text-xl items-center '>
                    ...
                    <div className='w-1/3 min-h-[300px] flex flex-col justify-between font-semibold text-xl items-center '>
                        <div className='w-[350px] flex items-center h-[200px]'>
