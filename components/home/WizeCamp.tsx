...
export default function WizeCamp() {
    return (
        <>
            <div className="max-w-[1300px] m-auto bg-[#E8E2F4] flex justify-between items-center rounded-2xl p-6 gap-4 my-4">
                <div className="bg-[#8C52FF] w-full h-full min-h-[500px] flex flex-col items-center justify-evenly rounded-2xl p-4">
                    ...
                    <div className="flex justify-between items-center px-2 py-4 my-4 rounded-lg text-white font-medium text-sm w-full max-w-[550px] bg-[#ffffff72]">
                ...
                <div className="w-full flex flex-wrap items-center justify-center gap-4 ">
                    <div className="w-full max-w-[250px] min-h-[230px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[230px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[230px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[230px] rounded-lg bg-white"></div>
                </div>
