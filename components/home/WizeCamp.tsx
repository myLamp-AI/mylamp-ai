...
export default function WizeCamp() {
    return (
        <>
            <div className="max-w-[1220px] m-auto bg-[#E8E2F4] flex justify-around items-center rounded-2xl p-6 gap-4 my-4">
                ...
                <div className="w-full flex flex-wrap items-center justify-center gap-4 min-h-[500px] max-w-[520px] ">
                    <div className="w-full max-w-[250px] min-h-[240px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[240px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[240px] rounded-lg bg-white"></div>
                    <div className="w-full max-w-[250px] min-h-[240px] rounded-lg bg-white"></div>
                </div>
